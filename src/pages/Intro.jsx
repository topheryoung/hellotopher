...
const Intro = () => (
  <section className="content">
    ...
    <h1>Topher Young</h1>
    <p>
      I am a seasoned software product and engineering leader located in
      Portland, OR, with a passion for creating exceptional web-based
      applications and products, building and mentoring talented teams, and
      delivering top-quality software.
    </p>
    <p>
